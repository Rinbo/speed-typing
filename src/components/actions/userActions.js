...
// @TODO move validate token to here
...
export const signInUser = async (obj, userDispatch, utilityDispatch) => {
  try {
    setHeaders();
...
export const signUpUser = async (obj, userDispatch, utilityDispatch) => {
  try {
    setHeaders();
...
export const signOutUser = async (
  ...
  destroyToken();
  userDispatch({ type: SIGN_OUT, payload: initialState });
  utilityDispatch({
    type: FLASH_MESSAGE,
    payload: {
